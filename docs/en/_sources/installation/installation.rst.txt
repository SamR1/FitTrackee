...
-  Download the last release (for now, it is the release v1.1.0b3):

.. code:: bash

   $ wget https://github.com/SamR1/FitTrackee/archive/1.1.0b3.tar.gz
   $ tar -xzf v1.1.0b3.tar.gz
   $ mv FitTrackee-1.1.0b3 FitTrackee
   $ cd FitTrackee
