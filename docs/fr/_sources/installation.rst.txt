...
-  Download the last release (for now, it is the release v0.9.7):

.. code:: bash

   $ wget https://github.com/SamR1/FitTrackee/archive/v0.9.7.tar.gz
   $ tar -xzf v0.9.7.tar.gz
   $ mv FitTrackee-0.9.7 FitTrackee
   $ cd FitTrackee
...
- Download the last release (for now, it is the release v0.9.7) and overwrite existing files:

.. code:: bash

   $ wget https://github.com/SamR1/FitTrackee/archive/v0.9.7.tar.gz
   $ tar -xzf v0.9.7.tar.gz
   $ cp -R FitTrackee-0.9.7/* FitTrackee/
   $ cd FitTrackee
