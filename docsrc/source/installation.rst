...
-  Download the last release (for now, it is the release v1.0.0b2):

.. code:: bash

   $ wget https://github.com/SamR1/FitTrackee/archive/1.0.0b2.tar.gz
   $ tar -xzf v1.0.0b2.tar.gz
   $ mv FitTrackee-1.0.0b2 FitTrackee
   $ cd FitTrackee
...
- Download the last release (for now, it is the release v1.0.0b2) and overwrite existing files:

.. code:: bash

   $ wget https://github.com/SamR1/FitTrackee/archive/v1.0.0b2.tar.gz
   $ tar -xzf v1.0.0b2.tar.gz
   $ cp -R FitTrackee-1.0.0b2/* FitTrackee/
   $ cd FitTrackee
