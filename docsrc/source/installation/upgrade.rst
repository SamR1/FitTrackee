...
- Download the last release (for now, it is the release v1.2.0) and overwrite existing files:

.. code:: bash

   $ wget https://github.com/SamR1/FitTrackee/archive/v1.2.0.tar.gz
   $ tar -xzf v1.2.0.tar.gz
   $ cp -R FitTrackee-1.2.0/* FitTrackee/
   $ cd FitTrackee
