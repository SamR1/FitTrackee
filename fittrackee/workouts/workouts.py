...
def get_statistics(
    ...
    *,
    ...
    return {
        ...
        "average_pace": (
            str(remove_microseconds(stats_query[12]))
            if get_pace and stats_query[12]
            else None
        ),
        "average_speed": (
        ...
        "count": stats_query[8],
        "max_pace": (
            str(remove_microseconds(stats_query[13]))
            if get_pace and stats_query[13]
            else None
        ),
        "max_speed": (
