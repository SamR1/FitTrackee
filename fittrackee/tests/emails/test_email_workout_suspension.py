...
from .template_results.email_workout_suspension import (
...
class TestEmailTemplateForWorkoutSuspension:
    template_name = "workout_suspension"
    ...
    @pytest.mark.parametrize(
        ...
        [
            ('en', 'FitTrackee - Your workout has been suspended'),
            ('fr', 'FitTrackee - Votre séance a été suspendue'),
        ],
    )
