...
from .template_results.email_user_suspension import (
...
class TestEmailTemplateForUserSuspension:
    template_name = "user_suspension"
    EMAIL_DATA: Dict[str, Optional[str]] = {
        "appeal_url": "http://localhost/profile/suspension",
    ...
    @pytest.mark.parametrize(
        ...
        [
            ('en', 'FitTrackee - Your account has been suspended'),
            ('fr', 'FitTrackee - Votre compte a été suspendu'),
        ],
    )
