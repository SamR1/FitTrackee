...
Your workout has been suspended, it is no longer visible.
...
Votre séance a été suspendue, elle n'est plus visible.
...
expected_en_html_body = """<body>
    <span class="preheader">Your workout has been suspended, it is no longer visible.</span>
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hi test,</h1>
                        <p>Your workout has been suspended, it is no longer visible.</p>
                          ...
                          <tr>
                            <td align="center">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                    <a href="http://localhost/workouts/CVsE8ERggQcHc7PcCdwGHC/" class="f-fallback button button--green" target="_blank">Appeal</a>
                                  </td>
                                </tr>
                              </table>
                            </td>
                        ...
                        <table class="body-sub" role="presentation">
                            <tr>
                             <td>
                                ...
                                <p class="f-fallback sub">http://localhost/workouts/CVsE8ERggQcHc7PcCdwGHC/</p>
                              </td>
                            </tr>
                          </table>
                      </div>
...
expected_fr_html_body = """ <body>
    <span class="preheader">Votre séance a été suspendue, elle n'est plus visible.</span>
    <table class="email-wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation">
      <tr>
        <td align="center">
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                ...
                <table class="email-body-inner" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Bonjour test,</h1>
                        <p>Votre séance a été suspendue, elle n'est plus visible.</p>
                          ...
                          <tr>
                            <td align="center">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                    <a href="http://localhost/workouts/CVsE8ERggQcHc7PcCdwGHC/" class="f-fallback button button--green" target="_blank">Faire appel</a>
                                  </td>
                                </tr>
                              </table>
                            </td>
