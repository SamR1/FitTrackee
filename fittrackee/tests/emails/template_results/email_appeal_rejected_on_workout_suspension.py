...
Your appeal on the following content suspension has been rejected.
...
Votre appel sur la suspension du contenu suivant a été rejeté.
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hi Test,</h1>
                        <p>Your appeal on the following content suspension has been rejected.</p>
                ...
                <table class="email-body-inner" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Bonjour Test,</h1>
                        <p>Votre appel sur la suspension du contenu suivant a été rejeté.</p>
