...
@pytest.fixture()
def workout_cycling_user_1_segment_0_chart_data_wo_coords(
    ...
    return [
        ...
        for data in workout_cycling_user_1_segment_0_chart_data
    ]


@pytest.fixture()
def workout_cycling_user_1_segment_0_chart_data_wo_hr(
    workout_cycling_user_1_segment_0_chart_data: List[Dict],
) -> List[Dict]:
    return [
        {
...
@pytest.fixture()
def workout_cycling_user_1_segment_0_chart_data_wo_hr_and_wo_coords(
    workout_cycling_user_1_segment_0_chart_data: List[Dict],
) -> List[Dict]:
    return [
        {
...
@pytest.fixture()
def gpx_file_without_time_on_last_point() -> str:
    return """<?xml version='1.0' encoding='UTF-8'?>
<gpx
  xmlns:gpxdata="http://www.cluetrust.com/XML/GPXDATA/1/0"
  xmlns:gpxtpx="http://www.garmin.com/xmlschemas/TrackPointExtension/v1"
...
@pytest.fixture()
def gpx_file_with_first_segment_empty() -> str:
    return """<?xml version='1.0' encoding='UTF-8'?>
<gpx
  xmlns:gpxdata="http://www.cluetrust.com/XML/GPXDATA/1/0"
  xmlns:gpxtpx="http://www.garmin.com/xmlschemas/TrackPointExtension/v1"
